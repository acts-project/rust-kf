...
void vector_of_hits() {
    ...
    size_t length = hits_vector.size();
...
void run_linear_kf() {
    ...
    DataPtr rust_matrix_struct_ptrs = run_linear_kf(hits_ptr, meas_ptr, number_of_sensors);
    cout << "made it here";
}

// running a constant magnetic beam experiment
void run_const_b_kf() {
