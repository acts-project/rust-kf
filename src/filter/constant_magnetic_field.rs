...
pub fn run(
    ...
    magnetic_field_vector: &Vec3                // direction of magnetic field 
    )  -> SmoothedData{
    ...
    for i in 0..input_length{
        let jacobian = jacobian::constant_magnetic_field(); //placeholder
        ...
        //predictions
        let pred_state_vec = prediction::constant_magnetic_state_vector(curr_sensor, next_sensor, &previous_state_vec, &magnetic_field_vector).expect("pred location out of bounds");
